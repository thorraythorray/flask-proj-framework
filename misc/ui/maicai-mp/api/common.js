...
module.exports.getBanner = (data, config = {}) => getRequest('/fla/mc/banner/list', data, config) // 获取首页轮播图列表
module.exports.getHomeCategoryList = (data, config = {}) => getRequest('/fla/mc/cates', data, config) // 首页分类
module.exports.getCategory = (data, config = {}) => getRequest('/fla/mc/cates', data, config) // 获取一级分类
...
module.exports.addRadio = (data = null, config = {}) => getRequest('/fla/mc/broadcast', data, config) // 获取首页广播