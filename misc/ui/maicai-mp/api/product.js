...
module.exports.getIndexFlashSale = (data, config = {}) => getRequest('/fla/mc/sales', data, config) // 限时抢购
module.exports.getFlashSaleList = (data, config = {}) => getRequest('/product/getFlashSaleList', data, config) // 查看限时促销商品列表
module.exports.getIndexModuleProductList = (data, config = {}) => getRequest('/fla/mc/prods', data, config) // 首页分类模块
